...
PATTERNS = {
    ...
    "SSH2 Encrypted Private Key": re.compile(r"-----BEGIN SSH2 ENCRYPTED PRIVATE KEY-----[\s\S]+?-----END SSH2 ENCRYPTED PRIVATE KEY-----"),
    "PuTTY Private Key": re.compile(r"PuTTY-User-Key-File-2"),
